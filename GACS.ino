...
/*FUNCTION
  *Name: Automatic_Care()
  *Description: Reads the sensors and applies the automatic care algorithm.
  *Return value: NONE.
*/
...
/*FUNCTION
  *Name: setup()
  *Description: Executes the Settings() and Autmaitc_Care() functions.
  *Return value: NONE.
*/
void setup() {
  digitalWrite(8, HIGH); //Turns off the water actuator.
  Settings(); //Apply settings.
  Automatic_Care(50, 0); //Set limits for water and light sensors.
}
